...
" }}}
" Syntax Highlighting: {{{
hi BoaRed      guifg=#d35b4b guibg=NONE gui=NONE cterm=NONE ctermfg=NONE ctermbg=NONE
hi BoaGreen    guifg=#8f9e44 guibg=NONE gui=NONE cterm=NONE ctermfg=NONE ctermbg=NONE
hi BoaYellow   guifg=#caa247 guibg=NONE gui=NONE cterm=NONE ctermfg=NONE ctermbg=NONE
hi BoaBlue     guifg=#919697 guibg=NONE gui=NONE cterm=NONE ctermfg=NONE ctermbg=NONE
hi BoaDarkBlue guifg=#898fac guibg=NONE gui=NONE cterm=NONE ctermfg=NONE ctermbg=NONE
hi BoaPurple   guifg=#b2809f guibg=NONE gui=NONE cterm=NONE ctermfg=NONE ctermbg=NONE
hi BoaAqua     guifg=#70a17c guibg=NONE gui=NONE cterm=NONE ctermfg=NONE ctermbg=NONE
hi BoaOrange   guifg=#c57c41 guibg=NONE gui=NONE cterm=NONE ctermfg=NONE ctermbg=NONE
hi BoaGray     guifg=#817466 guibg=NONE gui=NONE cterm=NONE ctermfg=NONE ctermbg=NONE
hi BoaBrown    guifg=#826a33 guibg=NONE gui=NONE cterm=NONE ctermfg=NONE ctermbg=NONE

hi Normal      guifg=#b8af96 guibg=NONE gui=NONE cterm=NONE ctermfg=NONE ctermbg=NONE
" see :help group-name
...
hi Underlined guifg=#919697 guibg=NONE gui=underline cterm=underline ctermfg=NONE ctermbg=NONE
" Ignore
hi Error guifg=#d35b4b guibg=NONE gui=bold,inverse cterm=bold,underline ctermfg=NONE ctermbg=NONE term=NONE
hi Todo guifg=fg guibg=NONE gui=bold,underline cterm=NONE ctermfg=NONE ctermbg=NONE

" see :help highlight-default
hi CursorLine guifg=NONE guibg=#292523 gui=NONE cterm=NONE ctermfg=NONE ctermbg=NONE
hi! link CursorColumn CursorLine
hi! link ColorColumn CursorLine
hi! link Conceal BoaBlue
hi Cursor guifg=NONE guibg=NONE gui=inverse cterm=inverse ctermfg=NONE ctermbg=NONE
" CursorIM
hi CursorLineNr   guifg=#caa247 guibg=#292523    gui=NONE cterm=NONE ctermfg=NONE ctermbg=NONE
hi Directory  guifg=#8f9e44 guibg=NONE gui=bold cterm=bold ctermfg=NONE ctermbg=NONE
hi DiffAdd    guifg=NONE guibg=#2b4018 gui=NONE cterm=NONE ctermfg=NONE ctermbg=NONE
hi DiffChange guifg=NONE guibg=#263840 gui=NONE cterm=NONE ctermfg=NONE ctermbg=NONE
hi DiffDelete guifg=#1a1a1a guibg=#4d2f2b gui=NONE cterm=NONE ctermfg=NONE ctermbg=NONE
hi DiffText   guifg=NONE guibg=#453b24 gui=NONE cterm=NONE ctermfg=NONE ctermbg=NONE
" EndOfBuffer
" TermCursor
" TermCursorNC
hi ErrorMsg guifg=#d35b4b guibg=NONE gui=bold cterm=bold ctermfg=NONE ctermbg=NONE
hi VertSplit guifg=#0a0707 guibg=NONE gui=NONE cterm=NONE ctermfg=NONE ctermbg=NONE
hi Folded     guifg=#817466 guibg=#2b2927    gui=NONE cterm=NONE ctermfg=NONE ctermbg=NONE
hi! link FoldColumn Folded
hi SignColumn guifg=NONE guibg=NONE cterm=NONE ctermfg=NONE ctermbg=NONE
hi IncSearch guifg=#518233 guibg=bg gui=inverse,bold cterm=inverse,bold ctermfg=NONE ctermbg=NONE
" Substitute
hi NonText guifg=#47423d guibg=NONE gui=NONE cterm=NONE ctermfg=NONE ctermbg=NONE
hi! link LineNr NonText
hi MatchParen   guifg=#de7621 guibg=NONE    gui=bold cterm=bold ctermfg=NONE ctermbg=NONE
hi ModeMsg      guifg=#93b329 guibg=NONE gui=bold cterm=bold ctermfg=NONE ctermbg=NONE
" MsgArea
hi MsgSeparator    guifg=NONE guibg=#263815 gui=NONE cterm=NONE ctermfg=NONE ctermbg=NONE
hi MoreMsg   guifg=#caa247 guibg=NONE    gui=bold cterm=bold ctermfg=NONE ctermbg=NONE
hi NormalFloat guifg=NONE guibg=#21261d gui=NONE cterm=NONE ctermfg=NONE ctermbg=NONE
hi NormalNC guifg=#b0a78f guibg=#111314 gui=NONE cterm=NONE ctermfg=NONE ctermbg=NONE
hi! link Question BoaGreen
hi QuickFixLine guifg=NONE guibg=#37322d gui=NONE cterm=NONE ctermfg=NONE ctermbg=NONE
hi Search    guifg=#1f1a17 guibg=#826a33 gui=bold cterm=bold ctermfg=NONE ctermbg=NONE
hi! link SpecialKey NonText
hi SpellBad guifg=NONE guibg=NONE gui=underline guisp=#e62922 cterm=underline ctermfg=NONE ctermbg=NONE
hi SpellCap guifg=NONE guibg=NONE gui=underline guisp=#a0b82e cterm=underline ctermfg=NONE ctermbg=NONE
hi! link SpellLocal SpellCap
hi! link SpellRare SpellCap
hi StatusLine guifg=#70655c guibg=#0a0707 gui=NONE cterm=NONE ctermfg=NONE ctermbg=NONE
hi StatusLineNC guifg=#403832 guibg=#0a0707 gui=NONE cterm=NONE ctermfg=NONE ctermbg=NONE
hi TabLine    guifg=#7c6f64 guibg=#0a0707    gui=NONE cterm=NONE ctermfg=NONE ctermbg=NONE
hi TabLineSel    guifg=#74853c guibg=#0a0707    gui=bold cterm=bold ctermfg=NONE ctermbg=NONE
hi! link TabLineFill Tabline
hi Title    guifg=#855c79 guibg=NONE    gui=bold cterm=bold ctermfg=NONE ctermbg=NONE
hi Visual guifg=NONE guibg=#3d3834 gui=NONE cterm=NONE ctermfg=NONE ctermbg=NONE
hi! link VisualNOS Visual
hi! link WarningMsg BoaOrange
" Whitespace
hi WildMenu     guifg=#919697 guibg=#3d3834    gui=bold cterm=bold ctermfg=NONE ctermbg=NONE
hi Pmenu guifg=#b8af96 guibg=#3d3834 gui=NONE cterm=NONE ctermfg=NONE ctermbg=NONE
hi PmenuSel guifg=#3d3834 guibg=#919697 gui=bold cterm=bold ctermfg=NONE ctermbg=NONE
hi! link  PmenuSbar Visual
hi PmenuThumb guifg=NONE guibg=#7c6f64 gui=NONE cterm=NONE ctermfg=NONE ctermbg=NONE

hi User1 guifg=#628c4c guibg=#0a0707
hi User2 guifg=#70655c guibg=#0a0707 gui=underline guisp=#e62922 cterm=underline ctermfg=NONE ctermbg=NONE
...
hi EasyMotionTarget guifg=#e04c38 guibg=NONE gui=bold cterm=bold ctermfg=NONE ctermbg=NONE
hi! link EasyMotionTarget2First EasyMotionTarget
hi EasyMotionTarget2Second guifg=#9eb339 guibg=NONE gui=bold cterm=bold ctermfg=NONE ctermbg=NONE
...
hi HighlightedyankRegion guifg=NONE guibg=#363D45 gui=NONE cterm=NONE ctermfg=NONE ctermbg=NONE
hi CocHoverRange guifg=NONE guibg=#2F3829 gui=NONE cterm=NONE ctermfg=NONE ctermbg=NONE
...
hi CocListMode guifg=#748c20 guibg=#0a0707 gui=bold cterm=bold ctermfg=NONE ctermbg=NONE
hi CocErrorHighlight guifg=NONE guibg=NONE gui=underline guisp=#d33e2a cterm=underline ctermfg=NONE ctermbg=NONE
hi CocWarningHighlight guifg=NONE guibg=NONE gui=underline guisp=#dea91d cterm=underline ctermfg=NONE ctermbg=NONE
hi CocInfoHighlight guifg=NONE guibg=NONE gui=underline guisp=#9dcc1f cterm=underline ctermfg=NONE ctermbg=NONE
hi CocHintHighlight guifg=NONE guibg=NONE gui=underline guisp=#50bf7b cterm=underline ctermfg=NONE ctermbg=NONE
hi CocGitRemovedSign guifg=#d35b4b guibg=NONE gui=bold cterm=bold ctermfg=NONE ctermbg=NONE
hi CocGitTopRemovedSign guifg=#d35b4b guibg=NONE gui=bold cterm=bold ctermfg=NONE ctermbg=NONE
hi CocGitChangedSign guifg=#70a17c guibg=NONE gui=bold cterm=bold ctermfg=NONE ctermbg=NONE
hi CocGitChangeRemovedSign guifg=#70a17c guibg=NONE gui=bold cterm=bold ctermfg=NONE ctermbg=NONE
hi CocGitAddedSign guifg=#8f9e44 guibg=NONE gui=bold cterm=bold ctermfg=NONE ctermbg=NONE
...
" hi htmlTagName guifg=#70a17c guibg=NONE gui=bold cterm=bold ctermfg=NONE ctermbg=NONE
...
hi htmlLink guifg=#a89984 guibg=NONE gui=underline cterm=underline ctermfg=NONE ctermbg=NONE

hi! link htmlSpecialChar BoaOrange

hi htmlBold guifg=fg guibg=NONE gui=bold cterm=bold ctermfg=NONE ctermbg=NONE
hi htmlBoldUnderline guifg=fg guibg=NONE gui=bold,underline cterm=NONE ctermfg=NONE ctermbg=NONE
hi htmlBoldItalic guifg=fg guibg=NONE gui=bold,italic cterm=bold,italic ctermfg=NONE ctermbg=NONE
hi htmlBoldUnderlineItalic guifg=fg guibg=NONE gui=bold,underline,italic cterm=bold,underline,italic ctermfg=NONE ctermbg=NONE
hi htmlUnderline guifg=fg guibg=NONE gui=underline cterm=underline ctermfg=NONE ctermbg=NONE
hi htmlUnderlineItalic guifg=fg guibg=NONE gui=underline,italic cterm=underline,italic ctermfg=NONE ctermbg=NONE
hi htmlItalic guifg=fg guibg=NONE gui=italic cterm=italic ctermfg=NONE ctermbg=NONE
...
hi vimCommentTitle guifg=#a89984 guibg=NONE gui=bold cterm=bold ctermfg=NONE ctermbg=NONE
...
hi markdownItalic guifg=#b8af96 guibg=NONE gui=italic cterm=italic ctermfg=NONE ctermbg=NONE

hi! link markdownH1 Directory
hi! link markdownH2 Directory
hi markdownH3 guifg=#caa247 guibg=NONE gui=bold cterm=bold ctermfg=NONE ctermbg=NONE
...
hi markdownLinkText guifg=#817466 guibg=NONE gui=underline cterm=underline ctermfg=NONE ctermbg=NONE
...
hi! svelteRepeat guifg=#caa247 guibg=NONE gui=bold cterm=bold ctermfg=NONE ctermbg=NONE
